...
<main id="main" class="main">
  <div class="pagetitle"> <h1> add new product variant </h1> </div>
  <section class="section"> 
    ...
    <form class="form-horizontal" action="{{URL::to('/createvariant')}}"  method="post" enctype="multipart/form-data">  
                                   {{ csrf_field() }}
     ...
     <div class="card-body"> 
      ...
      <!-- <div class="row mb-3"> 
        <label class="col-sm-2 col-form-label" for="inputText">Variant Title</label>
        <div class="col-sm-7"> 
          <input type="text" name="Varainttitle" class="form-control"> 
      ...
      <div class="row mb-3"> 
        ...
        <div class="col-sm-7"> 
          <input type="text" name="Varaintname" class="form-control"> 
      ...
      <div class="row mb-3"> 
        ...
        <div class="col-sm-7"> 
          <input type="checkbox" id="invalidCheck2" name="homedisplay" value="yes">
        </div>
      </div> 
